...
import { baseLinkStyleImpl, baseHeadingStyleImpl, baseParagraphStyleImpl, baseFocusStateStyleImpl } from '../styles/mixins.css';

export const markdownStyle = style({});

// Links
globalStyle(`${markdownStyle} a`, baseLinkStyleImpl);
globalStyle(`${markdownStyle} a:focus`, baseFocusStateStyleImpl);
...
// Bold text
globalStyle(`${markdownStyle} strong`, {
    fontWeight: fontWeights.bold,
});
...
// All code
globalStyle(`${markdownStyle} pre, ${markdownStyle} code`, {
